...
const PopularDishes = () => {
  return (
    <div className='mt-6 pr-6'>
        <div className='bg-[#1a1a1a] w-full rounded-lg h-[790px] '>
            ...
            <div className='overflow-y-scroll h-[710px] scrollbar-hide '>
            {
                popularDishes.map((dish)=>{
                    return(
                     <div key={dish.id} className='flex items-center mt-3 gap-4 bg-[#1f1f1f] rounded-[15px] px-6 py-4 mx-6'>
                        ...
                        <div>
                            ...
                            <p className='text-[#f5f5f5f5] text-xs font-semibold mt-1'><span className='text-[#ababab]'>Orders: </span>{dish.numberOfOrders} </p>
                        </div>
