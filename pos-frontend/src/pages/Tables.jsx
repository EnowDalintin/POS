...
const Tables = () => {
  ...
  return (
    <section className='bg-[#1f1f1f] h-[calc(100vh-5rem)] overflow-auto'>
      ...
      <div className="flex items-center justify-around gap-4">
                ...
                <button onClick={()=> setStatus("booked")} className={`text-[#ababab] ${status==="booked" && "bg-[#383838]"} text-lg rounded-lg px-5 py-2 font-semibold cursor-pointer`}>Booked</button>
            </div>
      </div>
